...
export const segments: SegmentConfig[] = [
  {
    ...
    items: [
      {
        id: 'luxury-beef-stroganoff',
        name: { en: 'Beef Stroganoff', ka: 'ბიფსტროგანოვი' },
        description: {
          en: 'Monday Greens food reference adapted into a composed fine-dining card treatment.',
          ka: 'Monday Greens-ის საკვების რეფერენსი, გამოყენებული ფაინ დაინინგის ბარათის დიზაინში.',
        },
        price: '38 ₾',
        category: { en: 'Signature', ka: 'საფირმო' },
        image: localAssets.chapters.luxury.beefStroganoff,
      },
      {
        id: 'luxury-beef-fillet',
        name: { en: 'Beef Fillet', ka: 'ბიფ ფილე' },
        description: {
          en: 'High-resolution Monday Greens plate reference for a crisp premium main card.',
          ka: 'მაღალი გარჩევადობის Monday Greens-ის კერძის რეფერენსი პრემიუმ მთავარი ბარათისთვის.',
        },
        price: '24 ₾',
      ...
      {
        id: 'luxury-gazpacho',
        name: { en: 'Gazpacho', ka: 'გასპაჩო' },
        description: {
          en: 'Bright Monday Greens dish reference used for a lighter luxury menu moment.',
          ka: 'ნათელი Monday Greens-ის კერძის რეფერენსი მსუბუქი პრემიუმ მენიუს მომენტისთვის.',
        },
        price: '27 ₾',
        category: { en: 'Signature', ka: 'საფირმო' },
        image: localAssets.chapters.luxury.gazpacho,
      },
      {
